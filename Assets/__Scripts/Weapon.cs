...
public class WeaponDefinition
{
    ...
    [Tooltip("Prefab of Weapon model that is attached to the players ship")]
...
public class Weapon : MonoBehaviour
{
    ...
    private Projectile_Hero MakeProjectile()
    {
        GameObject go;
        go = Instantiate<GameObject>(def.projectilePrefab, PROJECTILE_ANCHOR);
        Projectile_Hero p = go.GetComponent<Projectile_Hero>();
